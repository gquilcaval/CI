...
public class TareoReubicarMasivoPorDestajoCantidadImpl implements ITareoReubicarMasivoPorDestajoCantidadInteractor {
    ...
    @Inject
    public TareoReubicarMasivoPorDestajoCantidadImpl(@NonNull DataSourceLocal dataSourceLocal,
    ...
    @Override
    public Single<Long> crearResultadoParaReubicarEmpleado(ArrayList<ResultadoTareo> resultadoTareo,
    ...
    @Override
    public Single<EmpleadoResultadoRow> validarResultadoEmpleadoParaReubicar(String codTareo,
                                                                             String codEmpleado) {
        switch (preferenceManager.getModoTrabajo()) {
            case ModoTrabajo.LINEA:
                //todo revisar url
