...
public class ReubicarTipoEmpleadoInteractorImpl
        implements IReubicarTipoEmpleadoInteractor {
    ...
    @Inject
    public ReubicarTipoEmpleadoInteractorImpl(@NonNull DataSourceLocal dataSourceLocal,
