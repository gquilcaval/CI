...
public class ReubicarTipoEmpleadoFinalizarFragment extends BaseFragment
        implements IReubicarTipoEmpleadoFinalizarContract.View {
    ...
    @Inject
    ReubicarTipoEmpleadoFinalizarPresenter presenter;
    ...
    public ReubicarTipoEmpleadoFinalizarFragment() {

    }

    public ReubicarTipoEmpleadoFinalizarFragment newInstance(List<String> listaFechaTareos) {
        ReubicarTipoEmpleadoFinalizarFragment fragment = new ReubicarTipoEmpleadoFinalizarFragment();
    ...
    protected int getLayout() {
        return R.layout.fragment_reubicar_tipo_empleado_finalizar;
    }
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getContext(),
                        (timePicker, i, i1) -> {
                            ...
                            if (presenter.validarFechaFinTareo(etFechaFinTareo.getText().toString(), calendar.getTime())) {
                                ReubicarTipoEmpleadoActivity.horaInicio = "";//DateUtil.dateToStringFormat(calendar.getTime(), Constants.F_TIME_LECTURA); // momentaneo bloquear
