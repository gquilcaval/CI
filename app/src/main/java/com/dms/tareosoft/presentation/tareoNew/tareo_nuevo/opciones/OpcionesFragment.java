...
public class OpcionesFragment extends BaseFragment implements IOpcionesContract.View,
        View.OnClickListener {

    String TAG = OpcionesFragment.class.getSimpleName();
