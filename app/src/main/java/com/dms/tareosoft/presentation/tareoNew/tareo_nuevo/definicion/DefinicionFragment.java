...
public class DefinicionFragment extends BaseFragment implements IDefinicionContract.View,
        View.OnClickListener {

    static String TAG = DefinicionFragment.class.getSimpleName();
    ...
    public void listarClaseTareos(List<String> lista, int posicion) {
        ...
        spClaseTareo.setSelection(1);
        presenter.setClaseTareo(1);// selection clase tareo default int 1
    }
    ...
    public void actualizarVistaNiveles(List<NivelTareo> listaNiveles) {
        ...
        Log.d("aqui" ,"nombre ->" + presenter.preferenceManager.getNombreUsuario());
        if (presenter.preferenceManager.getPerfilUsuario() != 1) {
            moveToSearchActivity(1, 0, NivelConceptoTareo.CONCEPTO_1);
        }
            ...
            switch (requestCode) {
                case 100:
                    if (data != null) {
                        ...
                        Log.e(TAG, "conceptoResult ID: " + concepto);
                        switch (concepto) {
