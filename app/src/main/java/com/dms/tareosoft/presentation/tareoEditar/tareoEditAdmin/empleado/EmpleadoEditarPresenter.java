...
public class EmpleadoEditarPresenter extends BasePresenter<IEmpleadoEditarContract.View>
        implements IEmpleadoEditarContract.Presenter {

    String TAG = EmpleadoEditarPresenter.class.getSimpleName();
    ...
    @Inject
    IEditarEmpleadosInteractor interactor;
    @Inject
    ...
    @Inject
    public EmpleadoEditarPresenter() {
        mDetalleTareos = new ArrayList<>();
        //TODO   getView().setErroresDetallados(preferenceManager.getFlgErrores());
    }

    @Override
    public void evaluarEmpleado(String codEmpleado, String nomina,
                                String fecha, String hora) {
        Log.e(TAG, "evaluarEmpleado codEmpleado: " + codEmpleado + ", nomina: " + nomina + ", fecha: " + fecha + ", hora: " + hora);
                ...
                if (preferences.getRegistrarPersona()) {
                    disposable = interactor.validarExistenciaEmpleado(codEmpleado)
                            ...
                            .doOnComplete(() -> {
                                ...
                                Log.e(TAG, "evaluarEmpleado doOnComplete: ");
                                if (preferences.getRegistrarPersona()) {
                            ...
                            .subscribe(empleado -> {
                                        ...
                                        //Validar Nomina
                                        if (empleado.getTipoPlanilla().equals(nomina)) {
                    ...
                    validarEmpleadoNomina(codEmpleado, nomina, fecha, hora);
                }
            }
        }
    }
    ...
    public void registrarEmpleadoTareo(Empleado empleado, String fecha, String hora) {
        Log.e(TAG, "registrarEmpleadoTareo empleado: " + empleado +
        ...
        if (empleado.getEstadoEmpleado() == StatusEmpleado.EMPLEADO_NO_LIBRE) {
            ...
            nuevoDetalle.setFechaIngreso(DateUtil.changeStringDateTimeFormat(fecha, Constants.F_DATE_TAREO, Constants.F_DATE_TAREO));
            ...
            if (!TextUtils.isEmpty(empleado.getNombres())
                    && !TextUtils.isEmpty(empleado.getApellidoPaterno())
                    && !TextUtils.isEmpty(empleado.getApellidoMaterno()))
    ...
    @Override
    public List<DetalleTareo> getListDetalleTareo() {
    ...
    public void cargarDetalleTareo(String codigoTareo,
                                   @StatusFinDetalleTareo int statusFinTareo) {
        Log.e(TAG, "cargarDetalleTareo codigoTareo: " + codigoTareo + " statusFinTareo: " + statusFinTareo);
        getCompositeDisposable().add(interactor.obtenerListaDetalleTareo(codigoTareo, statusFinTareo)
                .subscribeOn(ExecutorThread)
                .observeOn(UiThread)
                .subscribe(detalleTareos -> {
                            Log.e(TAG, "cargarDetalleTareo subscribe: " + detalleTareos);
                            mDetalleTareos.clear();
                            mDetalleTareos.addAll(detalleTareos);
                            cargarListaEmpleados(codigoTareo, statusFinTareo);
                        }, error -> {
                            Log.e(TAG, "cargarDetalleTareo error: " + error);
                            Log.e(TAG, "cargarDetalleTareo error: " + error.toString());
                            Log.e(TAG, "cargarDetalleTareo error: " + error.getMessage());
                            getView().showErrorMessage(getView().getMessage(R.string.error_cargar_detalle_tareo), error.getMessage());
                        }
                ));
    }

    @Override
    public void cargarListaEmpleados(String codigoTareo,
                                     @StatusFinDetalleTareo int statusFinTareo) {
        ...
        disposable = interactor.obtenerListaEmpleados(codigoTareo, statusFinTareo)
                ...
                .subscribe(lista -> {
                            ...
                            Log.e(TAG, "cargarListaEmpleados error: " + error);
                            Log.e(TAG, "cargarListaEmpleados error: " + error.toString());
                            Log.e(TAG, "cargarListaEmpleados error: " + error.getMessage());
    ...
    public void setFechaInicio(String fechaInicio) {
        Log.e(TAG, "setFechaInicio fechaInicio:" + fechaInicio);
        mFechaInicio = fechaInicio;
        Log.e(TAG, "setFechaInicio mFechaInicio:" + mFechaInicio);
    }
    ...
    public boolean validarFecha(Date date, String hora) {
        ...
        Log.e(TAG, "validarFecha fechaInicioEmpleado: " + fechaInicioEmpleado);
    ...
    public boolean validarHora(String fecha, Date hora) {
        ...
        Log.e(TAG, "validarHora fechaInicioEmpleado: " + fechaInicioEmpleado);
        if (DateUtil.esMenorQue(Constants.F_LECTURA, fechaInicioEmpleado,
                Constants.F_DATE_TIME_TAREO,
                mFechaInicio + " " + mHoraInicio)) {
            getView().showWarningMessage(getView().getMessage(R.string.fecha_empleado_menor_fecha_tareo));
    ...
    public void registrarEmpleadoTareoPorDni(String codEmpleado, String fecha, String hora) {
        Log.e(TAG, "registrarEmpleadoTareoPorDni codEmpleado: " + codEmpleado + ", fecha: " + fecha + ", hora: " + hora);
        DetalleTareo nuevoDetalle = new DetalleTareo();
        nuevoDetalle.setFlgEstadoIniTareo(StatusIniDetalleTareo.TAREO_DETALLE_INICIADO);
