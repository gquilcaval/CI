...
public class TareoReubicarMasivoPorDestajoFinalizarPresenter extends BasePresenter<ITareoReubicarMasivoPorDestajoFinalizarContract.View>
        implements ITareoReubicarMasivoPorDestajoFinalizarContract.Presenter {

    String TAG = TareoReubicarMasivoPorDestajoFinalizarPresenter.class.getSimpleName();
    ...
    @Inject
    TareoReubicarMasivoPorDestajoFinalizarPresenter() {
