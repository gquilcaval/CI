...
public class OpcionesPresenter extends BasePresenter<IOpcionesContract.View>
        implements IOpcionesContract.Presenter {
    private final String TAG = OpcionesPresenter.class.getSimpleName();
