...
public class ReubicarTipoTareoFinalizarPresenter extends BasePresenter<IReubicarTipoTareoFinalizarContract.View>
        implements IReubicarTipoTareoFinalizarContract.Presenter {

    String TAG = ReubicarTipoTareoFinalizarPresenter.class.getSimpleName();
    ...
    @Inject
    ReubicarTipoTareoFinalizarPresenter() {
