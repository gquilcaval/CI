...
public class ReubicarTipoEmpleadoPresenter extends BasePresenter<IReubicarTipoEmpleadoContract.View>
        implements IReubicarTipoEmpleadoContract.Presenter {

    private final String TAG = ReubicarTipoEmpleadoPresenter.class.getSimpleName();
    ...
    @Inject
    IReubicarTipoEmpleadoInteractor interactor;
    @Inject
    ...
    @Inject
    public ReubicarTipoEmpleadoPresenter() {
        ...
        /*mListTareosFin = new ArrayList<>();
        mListEmpleadosFin = new ArrayList<>();
        mListaCodTareos = new ArrayList<>();*/
    }
    ...
    @Override
    public List<TareoRow> getListTareo() {
    ...
    @Override
    public List<AllEmpleadoRow> listEmpleadoPorFinalizar() {
    ...
    public void validarDatosParaFinalizar(boolean refrigerio,
        ...
        if (validaciones) {
            crearResultados(listaResultado, listResultadoXTareo);
        } else {
            getView().showErrorMessage("La hora de refrigerio no es correcta",
                    "La hora de refrigerio no es correcta");
            return;
    ...
    @Override
    public void crearResultados(List<ResultadoTareo> listaResultado,
                                List<AllEmpleadoRow> listResultadoXTareo) {
    ...
    private HashMap<String, List<AllEmpleadoRow>> hashEmpleados(List<AllEmpleadoRow> listEmpleadoPorFinalizar) {
