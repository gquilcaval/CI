...
public class DefinicionPresenter extends BasePresenter<IDefinicionContract.View>
        implements IDefinicionContract.Presenter {
    private final String TAG = DefinicionPresenter.class.getSimpleName();
