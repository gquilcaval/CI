...
public class TareoReubicarMasivoPorDestajoFinalizarFragment extends BaseFragment
        implements ITareoReubicarMasivoPorDestajoFinalizarContract.View {
    ...
    @Inject
    TareoReubicarMasivoPorDestajoFinalizarPresenter presenter;
    @Inject
    ...
    public TareoReubicarMasivoPorDestajoFinalizarFragment() {

    }

    public TareoReubicarMasivoPorDestajoFinalizarFragment newInstance(List<String> listaFechaTareos) {
        TareoReubicarMasivoPorDestajoFinalizarFragment fragment = new TareoReubicarMasivoPorDestajoFinalizarFragment();
